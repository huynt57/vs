            ...
            <div class="row-fluid">
                <div class="span12">				
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                Done! - List of orders which you received and must complete
                            </h3>
                        </div>
                        <?php
                                    ...
                                    <?php foreach ($orders as $order): ?>
                                        <tr>
                                            ...
                                            <td class='hidden-480'>
                                                ...
                                                <a href="<?php echo Yii::app()->createUrl('admin/staff/accept?id=' . $order->id) ?>" class="btn" rel="tooltip" title="Done!"><i class="icon-check"></i></a>	
                                                <a href="<?php echo Yii::app()->createUrl('admin/staff/reject?id=' . $order->id) ?>" class="btn" rel="tooltip" title="Reject"><i class="icon-remove"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>							
                                </tbody>
