...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            ...
            Bring inline: Yes 
            table { border-colapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; }*/
                        ...
                        <table border="0" width="600" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="color:#ffffff !important; font-size:20px; font-family: Arial, Verdana, sans-serif; padding-left:10px;" height="40">
                                    <center>
                                        <p style="font-size:15px; line-height:18px; font-family:Verdana">
                                            If you need support, <a href="http://vipservice.vn/aboutus" style="color:#ffffff !important;">contact us</a>
                                            <br />									
                                        </p>
                                    </center>
                                </td>
